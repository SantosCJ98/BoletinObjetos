...
public class Alimentos {
	...
	Alimentos(String nombre, float lipidos, float hidratoscarbono, float proteinas, boolean origenanimal,
	...
	static boolean esRecomendableparaDeportistas(float hidratoscarbono, float proteinas, float lipidos) {
		...
		if ((hidratoscarbono >= 55 && hidratoscarbono <= 65) && (proteinas >= 10 && proteinas <= 15)
	...
	static void VerAlimento(Alimentos alimento) {
		...
		System.out.println("Contenido Energético: "
				+ calculaContenidoEnergetico(alimento.hidratoscarbono, alimento.lipidos, alimento.proteinas)
				+ " Kcals.");
